...
$nowMilliSec=shell_exec("/var/www/html/BluetoothPlayer/scripts/bash/control.sh $mac Position");
    ...
    if(substr($songInfo,0,10) == "Error: org" || substr($nowMilliSec,0,10) == "Error: org" || substr($artist,0,16) == ": 0 Item: Title:"){
    echo"no valid track info";
    }else{
    //echo "<div id='trackinfo'> <p>Artist: ".$artist."   Title:  ".$title."   Zeit: ".$durmin.":".$durSec." / ".$nowMin."  ".$nowSec."  Zeit</p>";
