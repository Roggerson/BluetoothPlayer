//On scan click load, get all scanned Devices from txt file via php, php also echo's devices into popr item list
/*$(document).on('click', ".popr", function () {
